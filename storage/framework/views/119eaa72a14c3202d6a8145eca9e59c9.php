      ...
      <div class="main_container">
        <div class="col-md-3 left_col" >
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="z-index: -99;" >
            </div>
            ...
            <div class="profile clearfix" >
              ...
              <center><img src="<?php echo e(asset('build/images/logo.png')); ?>" alt="..." width="200" style="margin-top:-50px; margin-left: 15px;"></center>
            </div>
            </div>
            <!-- /menu profile quick info -->
            <br />
            ...
            <!-- /sidebar menu --><?php /**PATH C:\Users\pakhr\Desktop\Internship\Pharmacy-Management-System-Laravel\resources\views/admin-sidebar.blade.php ENDPATH**/ ?>